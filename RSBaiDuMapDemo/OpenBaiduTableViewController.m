//
//  OpenBaiduTableViewController.m
//  RSBaiDuMapDemo
//
...
#import "OpenBaiduTableViewController.h"

@interface OpenBaiduTableViewController ()<BMKOpenPanoramaDelegate> {
    BMKOpenPanorama *_openPanorama;//调起全景类
}

@end

@implementation OpenBaiduTableViewController
